...
public class AddNewFilesService(FilesApiClient filesApiClient, IFileSystem fileSystem, IOptions<DatabaseUpdaterConfiguration> config, ILogger<AddNewFilesBackgroundService> logger)
{
    /// <summary>
