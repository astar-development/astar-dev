...
//             ((Result<System.IO.Stream, Exception>.Error)result).Reason.Message.ShouldContain("simulated api failure");
//         }
//
//         [Fact]
...
//
//             result.ShouldBeOfType<Result<DriveItem, Exception>.Error>();
//             ((Result<DriveItem, Exception>.Error)result).Reason.Message.ShouldContain("upload error");
//         }
//
//         [Fact]
...
//
//             result.ShouldBeOfType<Result<DriveItem, Exception>.Error>();
//             ((Result<DriveItem, Exception>.Error)result).Reason.Message.ShouldContain("create folder failed");
//         }
//
//         [Fact]
...
//
//             // Assert
//             r1.ShouldBeOfType<Result<System.Collections.Generic.List<DriveItem>, Exception>.Error>();
//             r2.ShouldBeOfType<Result<System.IO.Stream, Exception>.Error>();
//             r3.ShouldBeOfType<Result<DriveItem, Exception>.Error>();
//             r4.ShouldBeOfType<Result<DriveItem, Exception>.Error>();
//         }
//     }
// }
