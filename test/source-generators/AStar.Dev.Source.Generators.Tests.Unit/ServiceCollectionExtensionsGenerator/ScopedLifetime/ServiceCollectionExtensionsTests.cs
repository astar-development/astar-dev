...
namespace AStar.Dev.Source.Generators.Test.Unit.ServiceCollectionExtensionsGenerator.ScopedLifetime;
...
public class ServiceCollectionExtensionsTests
{
    ...
    public void CreateTheServiceCollectionExtensionsForServiceWithoutInterface()
    {
        ...
        var syntaxTree = CSharpSyntaxTree.ParseText(EmbeddedResourceHelpers.GetResourceAsString("DemoService.cs"));
    ...
    {
        var generator = new Generators.ServiceCollectionExtensionsGenerator();
        var syntaxTree = CSharpSyntaxTree.ParseText(EmbeddedResourceHelpers.GetResourceAsString("DemoServiceWithInterface.cs"));
        var compilation = CSharpCompilation.Create(
