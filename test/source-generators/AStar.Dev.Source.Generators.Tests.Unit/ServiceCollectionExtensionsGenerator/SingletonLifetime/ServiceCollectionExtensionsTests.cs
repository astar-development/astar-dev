...
namespace AStar.Dev.Source.Generators.Test.Unit.ServiceCollectionExtensionsGenerator.SingletonLifetime;
...
public class ServiceCollectionExtensionsTests
{
    ...
    public void CreateTheServiceCollectionExtensionsForServiceWithoutInterface()
    {
        ...
        var syntaxTree = CSharpSyntaxTree.ParseText(EmbeddedResourceHelpers.GetResourceAsString("DemoServiceSingleton.cs"));
    ...
    {
        var generator = new Generators.ServiceCollectionExtensionsGenerator();
        var syntaxTree = CSharpSyntaxTree.ParseText(EmbeddedResourceHelpers.GetResourceAsString("DemoServiceWithInterfaceSingleton.cs"));
        var compilation = CSharpCompilation.Create(
