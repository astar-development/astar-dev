...
public class FileHandleServiceShould
{
    ...
    {
        var fileDetail = new FileDetail { FileName = new(fileName), DirectoryName = new("/test/path") };
    ...
    public void TruncateLongFileNamesTo350Characters()
    {
        ...
        var fileDetail = new FileDetail { FileName = new(longFileName), DirectoryName = new("/test/path") };
        var existingHandles = new List<FileHandle>();
