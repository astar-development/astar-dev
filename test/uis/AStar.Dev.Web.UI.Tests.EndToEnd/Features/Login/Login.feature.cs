...
namespace AStar.Dev.Web.UI.Features.Login
{
    ...
    public partial class LoginFeature : object, Xunit.IClassFixture<LoginFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Login", "Login", "Some explanation text", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 6
        await testRunner.WhenAsync("I enter them on the login page", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 7
        await testRunner.ThenAsync("I can see I am logged in as expected", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
