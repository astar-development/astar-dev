// using AStar.Dev.Infrastructure.FilesDb.TestContext;
//
// namespace AStar.Dev.Infrastructure.FilesDb.Data;
//
// public class FilesContextExtensions2Should(FilesContextFixture filesContextFixture) : IClassFixture<FilesContextFixture>
// {
...
//     // {
//     //     var response = sut.FileDetails.GetMatchingFiles("c:\\temp", Recursive, "searchTypeNotRelevant", IncludeSoftDeleted,
...
//     // {
//     //     var response = sut.FileDetails.GetMatchingFiles("c:\\temp", Recursive, "searchTypeNotRelevant", ExcludeSoftDeleted,
//     //                                                     IncludeMarkedForDeletion, ExcludeViewed, CancellationToken.None);
//     //
//     //     response.ToString()!.ShouldMatchApproved();
//     // }
...
//     // {
//     //     var response = sut.FileDetails.GetMatchingFiles("c:\\temp", Recursive, "Images", IncludeSoftDeleted,
//     //                                                     IncludeMarkedForDeletion, ExcludeViewed, CancellationToken.None);
//     //
//     //     response.ToString()!.ShouldMatchApproved();
//     // }
...
//     // {
//     //     var response = sut.FileDetails.GetMatchingFiles("c:\\temp", Recursive, "Images", ExcludeSoftDeleted,
//     //                                                     IncludeMarkedForDeletion, ExcludeViewed, CancellationToken.None);
//     //
//     //     response.ToString()!.ShouldMatchApproved();
//     // }
