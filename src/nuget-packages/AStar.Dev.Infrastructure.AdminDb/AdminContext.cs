...
public sealed class AdminContext : DbContext
{
    ...
    public AdminContext()
        : this(
               new ConnectionString { Value = "Data Source=sql1;Initial Catalog=AdminDb;Trusted_Connection=True;TrustServerCertificate=true", },
    ...
    public AdminContext(DbContextOptions<AdminContext> options)
        : base(options)
    {
        astarDbContextOptions = new AStarDbContextOptions();
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        if(astarDbContextOptions.EnableLogging)
        {
            ...
            if(astarDbContextOptions.IncludeSensitiveData) _ = optionsBuilder.EnableSensitiveDataLogging();
