...
/// </summary>
public sealed class DeletionStatus : AuditableEntity
{
    /// <summary>
    /// </summary>
    ...
    /// <summary>
    ///     Specifies the scope of the deletion being requested
    /// </summary>
    public DeletionScope DeletionScope { get; set; } = DeletionScope.DeleteFile;
}
